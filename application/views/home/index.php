...
<div id="carouselExampleControls" class="carousel slide mt-5" data-ride="carousel">
  ...
  <!-- Akhir Carousel -->
    ...
    <!-- Menu serching -->
    <section class="logindepan">
    <div class="container">
      <div class="row p-5 text-center mx-auto">
  ...
  <section class="features bg-light p-5">
    <div class="container">
      <div class="row mb-3">
        <div class="col">
          <h3>Informasi </h3>
          <p>Nama - nama Mahasiswa yang belum melakukan pengajuan Judul</p>
        </div>
      </div>         
  ...
  <table class="table">
    ...
    <div class="row m-3">
        <div class="col text-center">
          <a href="Home/lihat">Lihat Semua</a>
        </div>
</section>
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
            <th>1</th>
            <td>Pendaftaran Pengajan Judul Skripsi (skripsi.ac.id)</td>
            <td>1 November</td>
            <td>14 Desember 2019</td>
        </tr>
        <tr>
            <th>2</th>
            <td>Seminar Proposal Skripsi</td>
            <td>Sabtu, 14 Januari 2020</td>
            <td>Senin, 27 Januari 2020</td>
        </tr>
        <tr>
            <th>3</th>
            <td>Seminar Hasil Skrips</td>
            <td>Sabtu, 08 April 2020</td>
            <td>Kamis, 15 April 2020</td>
        </tr>
      </tbody>
    </table>
